...
//
// Why this exists. Every parser in src/resolvers/ is verified against
...
// jailbroken physical arm64 test device, read-only -- nothing was installed or
...
// framework:
//
//   scp <ssh-config-alias>:/var/jb/usr/lib/liblz4.1.dylib .
//
