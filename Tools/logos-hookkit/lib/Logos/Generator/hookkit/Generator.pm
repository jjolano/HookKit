...
sub staticDeclarations {
    ...
    return join("\n", ($self->SUPER::staticDeclarations(),
        ...
        "}",
        "__attribute__((unused)) static int _hk_hookkit_hook_message(Class _cls, SEL _sel, IMP _new, IMP *_old, int _isMeta) {",
        "    if (!_cls || !_sel || !_new) return -1;",
        "    hk_runtime_t *_rt = _hk_hookkit_runtime(); if (!_rt) return -1;",
        ...
        "    hk_hook_spec_t _spec; hk_objc_spec_init(&_spec, \"logos.hook\", _t, (void*)_new);",
        ...
        "}",
        "__attribute__((unused)) static int _hk_hookkit_hook_function(void *_sym, void *_rep, void **_out) {",
        ...
        "    _spec.stable_hook_id=\"logos.func\"; _spec.target_kind=HK_TARGET_FUNCTION_ADDRESS;",
