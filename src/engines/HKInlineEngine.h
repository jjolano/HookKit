...
//
// Reuse survey: the mechanism core is src/native/hk_arm64.{h,c}, reused as-is and
...
// unlike src/native/hk_swift.c (arm64-gated device code, hence the deferred Swift
// engine) there was nothing to port. What is NOT reused is
// src/internal/HKInlinePreflight.m: it is Objective-C and its central check is
