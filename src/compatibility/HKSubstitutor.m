...
static bool hk_legacy_collect_backend_id(void *opaque,
    ...
    // The v1 picker rows key on the group token; the display label is the
    // runtime's own human-readable spelling and is not part of that contract.
    (void)display_name;
